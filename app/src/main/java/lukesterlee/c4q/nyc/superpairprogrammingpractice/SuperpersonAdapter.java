package lukesterlee.c4q.nyc.superpairprogrammingpractice;
...
public class SuperpersonAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        List<java.lang.String> powersList = superPerson.getPowersList();
        java.lang.String powerStr = powersList.get(0);
